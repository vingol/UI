...
class Ui_MainWindow_show_plot(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow",
                                      "<html><head/><body><p><span style=\" font-size:24pt;\">风电/光伏数据展示</span></p><p><br/></p></body></html>"))
        ...
        self.comboBox_datatype.setItemText(3, _translate("MainWindow", "NWP辐照度"))
        ...
        self.pushButton.setText(_translate("MainWindow", "显示曲线"))
